            ...
            <div class="contenedor__principal">
                ...
                <div class="container__EditarRecorrido">
                    ...
                    <div class="container_SelectorRecorrido">
                        ...
                        <%
                        //  ● EDITAR  
                        String select_Recorrido = request.getParameter("id_selectRecorrido");
                        ...
                        try {
                            ...
                            if (nombreZona == null || nombreZona.isEmpty() || nombreZona.contains("<")){
                                out.print("<h3> Falta ingresar Parametros </h3>");
                            }else{
                                  recorrido_update.setId(id_selectRecorrido);
                                  recorrido_update.setNombreZona(nombreZona);
                                  recorrido_update.setDia(dia);
                                  recorrido_update.setResponsableZona(responsableZona);
                                  recorrido_update.setAsistenteZona(asistenteZona);
                            }
                        ...
                        re_rep.update(recorrido_update);
                    ...
                    <div class="container_Confirmacion">
                        <form action="../editar_Recorridos.jsp" method="get">
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <h3>
                                        <%
                                            recorrido_update = re_rep.getById(recorrido_update.getId());
                                            out.print(
                                                recorrido_update.getId()+". " 
                                                +recorrido_update.getNombreZona()+", "
                                                +recorrido_update.getDia()+" ( "
                                                +recorrido_update.getResponsableZona()+" - "
                                                +recorrido_update.getAsistenteZona()+")"
                                            );
                                        %>
                                        </h3>
                                    </td> 
