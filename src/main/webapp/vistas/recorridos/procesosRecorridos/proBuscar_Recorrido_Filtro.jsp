...
<html lang="en">
            ...
            <div class="contenedor__principal">
                ...
                <div class="container__Buscador">
                    ...
                    <div class="container_Filtro">
                        <form action="proBuscar_Recorrido_Result.jsp" method="get">
                            <table>
    <%  
                            //  ● FILTROS  
                            ...
                            //  ♦ ZONA
                            if ("nombreZona".equalsIgnoreCase(filtro)){
    %>
                                <tr><td><h2>ZONA</h2></td></tr>
                                <tr>
                                    <td><input  type="text" name="buscarZona" placeholder="Buscador Zonas"
                                                style="  width: 85%; 
                                                color: black;
    ...
    <%
                            ...
                            //  ♦ RESPONSABLE
                            if ("responsable".equalsIgnoreCase(filtro)){
    %>
                                <tr><td><h2>RESPONSABLE</h2></td></tr>
                                <tr>
                                    <td>
                                        <select name="buscarResponsable" style="text-transform: capitalize;">
    ...
    <% 
                                    ...
                                    lista_asistente.add(r.getResponsableZona().toLowerCase());
                                    }
                                    for(Object responsable: lista_asistente){
                                    out.print("<option value=" +responsable.toString().toUpperCase()+">"+responsable+"</option>");
                                    }
    %>
                                        </select>
                                    </td>
    ...
    <%
                            ...
                            //  ♦ ASISTENTE
                            if ("asistente".equalsIgnoreCase(filtro)){
    %>
                                <tr><td><h2>ASISTENTE</h2></td></tr>
                                <tr>
                                    <td>
                                        <select name="buscarAsistente" style="text-transform: capitalize;">
                                            <option disabled selected="true" style="color: black;">
    ...
    <% 
                                    ...
                                    Set<Object> lista_asistente = new TreeSet(); 
                                    for(Recorrido r: re_rep.getAll()){
                                    lista_asistente.add(r.getAsistenteZona().toLowerCase());
                                    }
                                    for(Object asistente: lista_asistente){
                                    out.print("<option value=" +asistente.toString().toUpperCase()+">"+asistente+"</option>");
                                    }
    %>
                                        </select>
                                    </td>
