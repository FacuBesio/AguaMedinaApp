            ...
            <div class="contenedor__principal">
                ...
                <div class="container__main_ClientesPersona">
                    ...
                    %>
                        ...
                        <tr>
                            <td>
                                <a href="procesosClientesPersona/proBuscar_Persona_Result.jsp?buscarDia=Miercoles">Miércoles</a>
                            </td>
                        </tr>
                        <tr>
                            <td>
                   ...
                   <%
                    ...
                    %>
                        ...
                        <tr>
                            <td>
                                <a href="procesosClientesPersona/proBuscar_Persona_Result.jsp?buscarDia=Sabados">Sábados</a>
                            </td>
                        </tr>
                        <tr>
                            <td>
